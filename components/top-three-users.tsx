  ...
  return (
    <div className="relative mb-6 pt-8 pb-6">
      ...
      <div className="relative flex justify-center items-end">
        {/* Second Place */}
        {second && (
          <div className="flex flex-col items-center mx-3 z-10 transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-slate-400 to-slate-600 text-white rounded-full h-7 w-7 flex items-center justify-center font-bold text-sm mx-auto mb-1">
                2
              </div>
        ...
        {/* First Place */}
        {first && (
          <div className="flex flex-col items-center mx-3 z-20 -mt-6 transform hover:scale-105 transition-transform duration-300">
            <div className="relative mb-2">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-full h-8 w-8 flex items-center justify-center font-bold mx-auto mb-1 shadow-lg">
                1
              </div>
        ...
        {third && (
          <div className="flex flex-col items-center mx-3 z-10 transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-orange-400 to-orange-600 text-white rounded-full h-6 w-6 flex items-center justify-center font-bold text-xs mx-auto mb-1">
                3
              </div>
